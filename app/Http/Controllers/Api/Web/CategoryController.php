...
class CategoryController extends Controller
{
    ...
    {
        $category = Category::with('blogs.category', 'galleries.category')->where('slug', $slug)->first();

        if($category) {
            //return with Api Resource
            return new CategoryResource(true, 'List Data Blog dan Galleries By Category', $category);
        }
